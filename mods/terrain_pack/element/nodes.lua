...
minetest.register_node("element:water_flowing", {
	...
	liquid_viscosity = 1,
	post_effect_color = {a = 137, r = 30, g = 35, b = 40},
...
minetest.register_node("element:methane", {
	...
	inventory_image = "fire_purple_flame.png",
	wield_image = "fire_purple_flame.png",
	drawtype = "airlike",
	paramtype = "light",
	sunlight_propagates = true,
	walkable = false,
	...
	air_equivalent = true,
	damage_per_second = 1,
	post_effect_color = {a = 23, r = 30, g = 0, b = 90},
	drop = "",
...
minetest.register_node("element:dirt_with_grass_jungle", {
	description = S("Dirt with Grass"),
	tiles = {"element_rainforest_litter.png", "element_dirt_red.png",
		{name = "element_dirt_red.png^element_rainforest_litter_side.png",
			tileable_vertical = false}},
	groups = {crumbly = 2, soil = 1, mutable = 1},
	soil = {
		base = "element:dirt",
