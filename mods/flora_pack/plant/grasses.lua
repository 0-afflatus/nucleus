...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"element:desert_sand", "element:sand", "element:dirt_with_snow", "element:dirt_with_ice", "element:dirt_with_dry_grass"},
	sidelen = 16,
	noise_params = {
		offset = 0,
		scale = 0.015,
...
minetest.register_decoration({
	...
	biomes = {"grassland", "woodland_swamp", "woodland", "mediterranean", "steppe", "savanna", "savanna_swamp", "tropical_ocean", "rainforest_swamp"},
	y_min = 1,
	y_max = 40,
	decoration = {"plant:juncus_0", "plant:juncus_1", "plant:reedmace_height_2", "plant:reedmace_height_3", "plant:reedmace_height_3_spikes"}
})
...
minetest.register_decoration({
	deco_type = "schematic",
	place_on = {"element:dirt", "element:dirt_with_grass", "element:dirt_red", "element:dirt_jungle", "element:dirt_with_grass_jungle", "element:mud", "element:sand"},
	sidelen = 16,
	noise_params = {
		offset = -0.7,
		scale = 0.7,
	...
	biomes = {"savanna_swamp", "rainforest_swamp"},
	y_min = 0,
	y_max = 1,
