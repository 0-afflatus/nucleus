-- Nucleus 0.1 --
-- mods/bucket/wooden_bucket.lua --

-- based on Minetest 0.4 mod: bucket
...
minetest.register_craftitem("bucket:wooden_empty", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if node.name == "element:lava" or 
				node.name == "element:lava_flowing" or 
				node.name == "element:lava_source" then
...
bucket.register_contents(
	"element:water_source",
	"element:water_flowing",
	"bucket:wooden_water",
...
bucket.register_contents(
	"element:river_water_source",
	"element:river_water_flowing",
	"bucket:wooden_river_water",
	"bucket_wood_water.png",
	S("Pail of River Water"),
	{water_bucket = 1}
)
